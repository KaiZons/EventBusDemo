...
namespace Hao.DbContext
{
    ...
    public static class SqlSugarServiceCollectionExtensions
    {
        ...
        /// </returns>
        public static IServiceCollection AddSqlSugarClient(this IServiceCollection serviceCollection,
                                                                            Action<ConnectionConfig> configAction,
                                                                            ServiceLifetime contextLifetime = ServiceLifetime.Scoped,
                                                                            ServiceLifetime configLifetime = ServiceLifetime.Scoped)
            => AddSqlSugarClient(serviceCollection, delegate (IServiceProvider p, ConnectionConfig b) { }, contextLifetime, configLifetime);
                                                                        ...
                                                                        ServiceLifetime configLifetime = ServiceLifetime.Scoped)
        {
            ...
            AddCoreServices(serviceCollection, configAction, configLifetime);

            serviceCollection.TryAdd(new ServiceDescriptor(typeof(SqlSugarClient), typeof(SqlSugarClient), contextLifetime));

            return serviceCollection;
        }
        private static void AddCoreServices(IServiceCollection serviceCollection, Action<IServiceProvider, ConnectionConfig> configAction, ServiceLifetime configLifetime)
        {
